...
if __name__== '__main__':
    ...
    sleep(2)
    camera.capture('/home/pi/Documents/diffusercam/bernat/from_camera/test11/x.png', 'png')



    # for k in range(0,25):
        # name='/home/pi/Documents/diffusercam/bernat/from_camera/test10/black'+str(k)+'.png'
        # print(k)
        # sleep(2)
