...
if __name__== '__main__':
    ...
    sleep(2)
    # camera.capture('/home/pi/Documents/diffusercam/bernat/from_camera/test12/sbackground.png', 'png')



    for k in range(0,20):
        name='/home/pi/Documents/diffusercam/bernat/from_camera/test12/s'+str(k)+'.png'
        print(k)
        # sleep(2)
